...
public class UploadController {
    ...
    @ResponseBody
    public Result upload(HttpServletRequest httpServletRequest, @RequestParam("file") MultipartFile file, HttpServletResponse response) throws URISyntaxException {
